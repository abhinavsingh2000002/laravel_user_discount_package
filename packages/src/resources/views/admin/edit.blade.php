...
<body class="bg-gray-50">
    <div class="min-h-screen">
        ...
        <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('discounts.update', $discount) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="e.g., Black Friday Sale" required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="type" id="type" onchange="updateValueLabel()"
                                    ...
                                    <option value="fixed"
                                        {{ old('type', $discount->type) == 'fixed' ? 'selected' : '' }}>Fixed Amount
                                    </option>
                                </select>
                            </div>

                            <div>
                                <label for="value" id="valueLabel"
                                    class="block text-sm font-medium text-gray-700 mb-2">
                                    <i
                                        class="fas fa-dollar-sign mr-2"></i>{{ $discount->type == 'percentage' ? 'Percentage Value' : 'Fixed Amount' }}
                                </label>
                                <div class="relative">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <select name="active" id="active"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                                <option value="1" {{ old('active', $discount->active) == 1 ? 'selected' : '' }}>
                                    Active</option>
                                <option value="0" {{ old('active', $discount->active) == 0 ? 'selected' : '' }}>
                                    Inactive</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="per_user_cap" id="per_user_cap" min="0"
                                value="{{ old('per_user_cap', $discount->per_user_cap) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
